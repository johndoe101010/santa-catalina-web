  ...
  head: () => ({
    meta: [
      { title: "La empresa | Santa Catalina S.A." },
      {
        name: "description",
        content:
          "Santa Catalina S.A., ferretería en Concepción con más de 30 años acompañando a familias, constructores y productores con materiales de calidad.",
      },
      ...
      { property: "og:title", content: "La empresa | Santa Catalina S.A." },
      {
        ...
        content:
          "Más de 30 años en Concepción acompañando a familias, constructores y productores.",
      },
      ...
      { name: "twitter:title", content: "La empresa | Santa Catalina S.A." },
      {
        ...
        content:
          "Ferretería en Concepción, Paraguay, con más de 30 años de trayectoria.",
      },
