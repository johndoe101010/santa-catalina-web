...
export function CompanySection() {
  ...
  return (
    <section id="empresa" ref={ref} className="section-anchor flex min-h-[calc(100vh-80px)] items-center overflow-hidden py-16 lg:py-20">
      <div className="mx-auto max-w-[1360px] px-5 grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-20 items-center">
        <div className="relative aspect-[4/5] max-h-[620px] rounded-3xl overflow-hidden shadow-strong lg:h-[min(68vh,620px)] lg:aspect-auto">
          <motion.img
            style={{ y: imgY }}
            src={interior}
          ...
          <div className="absolute bottom-6 left-6 right-6 text-cream">
            <div className="text-xs uppercase tracking-widest opacity-70 mb-1">Nuestro local</div>
            <div className="font-display font-bold text-xl">Av. Pinedo, Concepción</div>
          </div>
        </div>
        ...
        <div>
          <Reveal direction="right">
            ...
            <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-black leading-[0.95] text-balance mb-6">
              Una tienda local con <span className="text-orange">presencia real.</span>
            </h2>
            <p className="text-base sm:text-lg text-foreground/70 leading-relaxed mb-10 text-pretty">
              Desde 1994 acompañamos a familias, constructores y productores de Concepción.
              Somos un equipo que conoce a sus clientes por nombre y que recomienda lo que
              realmente sirve para cada trabajo.
            </p>
          </Reveal>
            ...
            {STATS.map((s, i) => (
              <Reveal key={s.label} direction="up" delay={i * 0.1}>
                <div className="relative pl-5">
                  <span className="absolute left-0 top-2 bottom-2 w-1 rounded-full bg-gradient-orange" />
